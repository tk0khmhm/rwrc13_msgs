"""autogenerated by genpy from rwrc12_msgs/GpsGsvGsa.msg. Do not edit."""
import sys
...
class GpsGsvGsa(genpy.Message):
  _md5sum = "e8ce9c18ae459d70e3a672dd9244372b"
  _type = "rwrc12_msgs/GpsGsvGsa"
...
"""
  __slots__ = ['header','lat','lon','precision','satelites','hdop','alt','geo','lack','rms','smd1','smd2','smo','laed','loed','aled','id','pdop','vdop','gs','tn','sn','elevation','azimuth','snr']
  _slot_types = ['std_msgs/Header','float64','float64','int32','int32','float32','float64','float64','int32','float32','float32','float32','float32','float32','float32','float32','int32[]','float32','float32','float32','int32','int32[]','int32[]','int32[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,lat,lon,precision,satelites,hdop,alt,geo,lack,rms,smd1,smd2,smo,laed,loed,aled,id,pdop,vdop,gs,tn,sn,elevation,azimuth,snr
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3fi.pack(_x.pdop, _x.vdop, _x.gs, _x.tn))
      length = len(self.sn)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pdop, _x.vdop, _x.gs, _x.tn,) = _struct_3fi.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
