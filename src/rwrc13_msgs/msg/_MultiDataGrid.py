"""autogenerated by genpy from rwrc13_msgs/MultiDataGrid.msg. Do not edit."""
import sys
...
class MultiDataGrid(genpy.Message):
  ...
  _type = "rwrc13_msgs/MultiDataGrid"
...
"""
  ...
  _slot_types = ['std_msgs/Header','nav_msgs/MapMetaData','rwrc13_msgs/MultiDataCell[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rwrc13_msgs.msg.MultiDataCell()
        _v5 = val1.base
        _v6 = _v5.header
        start = end
        end += 4
