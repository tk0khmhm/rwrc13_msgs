...
(cl:defmethod cl:initialize-instance :after ((m <Gps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rwrc13_msgs-msg:<Gps> is deprecated: use rwrc13_msgs-msg:Gps instead.")))
...
(cl:defmethod precision-val ((m <Gps>))
...
(cl:defmethod satelites-val ((m <Gps>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Gps>)))
  ...
  "6adce422ea044d6efe087698ff8cf44d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Gps)))
  "Returns md5sum for a message object of type 'Gps"
  "6adce422ea044d6efe087698ff8cf44d")
