...
(cl:defmethod cl:initialize-instance :after ((m <PathCheck-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathCheck-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rwrc13_msgs-srv:<PathCheck-request> is deprecated: use rwrc13_msgs-srv:PathCheck-request instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <PathCheck-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rwrc13_msgs-srv:path-val is deprecated.  Use rwrc13_msgs-srv:path instead.")
  (path m))

(cl:ensure-generic-function 'map-val :lambda-list '(m))
(cl:defmethod map-val ((m <PathCheck-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rwrc13_msgs-srv:map-val is deprecated.  Use rwrc13_msgs-srv:map instead.")
  (map m))
...
(cl:defmethod cl:initialize-instance :after ((m <PathCheck-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathCheck-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rwrc13_msgs-srv:<PathCheck-response> is deprecated: use rwrc13_msgs-srv:PathCheck-response instead.")))

(cl:ensure-generic-function 'cost-val :lambda-list '(m))
(cl:defmethod cost-val ((m <PathCheck-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rwrc13_msgs-srv:cost-val is deprecated.  Use rwrc13_msgs-srv:cost instead.")
  (cost m))

(cl:ensure-generic-function 'out_cells-val :lambda-list '(m))
(cl:defmethod out_cells-val ((m <PathCheck-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rwrc13_msgs-srv:out_cells-val is deprecated.  Use rwrc13_msgs-srv:out_cells instead.")
  (out_cells m))
