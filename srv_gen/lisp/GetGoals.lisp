...
(cl:defmethod cl:initialize-instance :after ((m <GetGoals-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGoals-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rwrc13_msgs-srv:<GetGoals-request> is deprecated: use rwrc13_msgs-srv:GetGoals-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetGoals-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetGoals-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rwrc13_msgs-srv:<GetGoals-response> is deprecated: use rwrc13_msgs-srv:GetGoals-response instead.")))
